...
export async function middleware(request: NextRequest): Promise<NextResponse> {
  ...
  // /api/* 路由由各自 handler 自行鉴权，中间件直接放行
  // 涉及路由：/api/public/tracking（公开）、/api/auth/*、/api/transport-bills、
  //   /api/staff/*、/api/admin/*、/api/client/*、/api/loading-manifests/*
  // 如需在中间件层统一拦截 API，请在此分支内扩展
