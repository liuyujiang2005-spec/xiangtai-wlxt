...
export function AuthBar() {
  ...
  return (
    <div className="no-print flex items-center gap-2 text-sm text-slate-600">
      ...
      <button
        ...
        className="inline-flex items-center gap-1 rounded-lg border border-slate-200 px-2 py-1 text-xs font-medium text-slate-700 transition-colors hover:border-brand-accent/30 hover:bg-brand-accent/5 hover:text-brand-accent"
      >
