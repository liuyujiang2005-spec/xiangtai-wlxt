    ...
    <aside className="no-print flex min-h-[calc(100vh-57px)] w-[13.5rem] shrink-0 flex-col border-r border-slate-200 bg-white sm:w-56">
            ...
            <Link
              ...
              className={`flex items-center gap-2 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
                active
                  ...
                  : "border border-transparent text-slate-700 hover:bg-slate-100 hover:text-brand-accent"
              }`}
            >
      ...
      <div className="shrink-0 border-t border-slate-100 p-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:border-brand-accent/30 hover:bg-brand-accent/5 hover:text-brand-accent"
        >
