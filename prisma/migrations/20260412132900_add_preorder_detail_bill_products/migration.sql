...
CREATE TABLE "BillProduct" (
    ...
    CONSTRAINT "BillProduct_transportBillId_fkey" FOREIGN KEY ("transportBillId") REFERENCES "TransportBill" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_TransportBill" ("actualCBM", "actualWeight", "clientUserId", "createdAt", "domesticTracking", "estimatedPieces", "goodsName", "id", "isForecastPending", "isMinChargeWaived", "shippingMethod", "trackingNumber", "unitPrice", "warehouse") SELECT "actualCBM", "actualWeight", "clientUserId", "createdAt", "domesticTracking", "estimatedPieces", "goodsName", "id", "isForecastPending", "isMinChargeWaived", "shippingMethod", "trackingNumber", "unitPrice", "warehouse" FROM "TransportBill";
